...
var xLabsPlayer = {
    ...
    onApiReady : function() {
        ...
        if( xLabsPlayer.videoId ) {
            ...
            document.getElementById( "youtube_addr_txt" ).value = "https://www.youtube.com/watch?v=yIEpzyssJEU"
...
xLabs.setup( xLabsPlayer.onApiReady, xLabsPlayer.onApiState, null, "c09ce657-f1d4-434f-852c-e41bb0907ebb" );
